...
export function MetaConfigForm({ clientId, initialConfig }: Props) {
  ...
  async function handleSave() {
    setSaving(true)
    try {
      await api.put(`/clients/${clientId}/meta-config`, config)
  ...
  async function handleReset() {
    ...
    setSaving(true)
    try {
      const fresh = await api.post<MetaConfigShape>(`/clients/${clientId}/meta-config/reset`, {})
      setConfig(fresh)
